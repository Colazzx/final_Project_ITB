...
unsigned int TimeSampling = 15000, DeltaTime;
...
float referenceModel(){  
  float referenceSignal = 110*exp(-0.004018*(Time - StartTime - TimeSampling)/1000)+97.99425;
...
float measurePlantState() {
  ...
  //float NTU2 = -706 * (voltage2 * voltage2 * voltage2) + 2519.4 * (voltage2 * voltage2) - 2990 * voltage2 + 1277.2 + 180;
  return NTU2;
}
